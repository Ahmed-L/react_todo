    ...
    return(
        <div className=''>
            ...
            <form className='flex flex-row justify-center' onSubmit={(event)=>{
                ...
                <input ref={inputRef} className='w-8/12 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-white font-semibold focus:border-indigo-500 focus:outline-none' type="text" name='new-task' placeholder='task description' value={undefined}></input>
